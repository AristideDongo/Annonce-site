...
import Image1 from '@/images/Tablet login-rafiki.png';
import Link from "next/link";
import { FaEnvelope, FaLock } from 'react-icons/fa'; // Importez les icônes
            ...
            <div className="w-full flex-1 mt-8">
              ...
              <div className="mx-auto max-w-xs">
                <div className="relative">
                  ...
                  <input
                    className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white pl-10"
                    type="email"
                    placeholder="Email"
                  />
                </div>
                ...
                >
                  ...
                  <span className="ml-">Connexion</span>
                </button>
                <p className="mt-6 text-base text-gray-600 text-center">
                  Pas encore de compte ? 
                  <Link href="/register" className="border-b border-blue-500 text-blue-500 border-dotted">
                    {` S'inscrire `}
                  </Link>
                </p>
              </div>
